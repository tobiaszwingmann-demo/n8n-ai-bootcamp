...
```markdown 
Tickets are stored in the directory `project 4/tickets/`.
Example path: "project 4/tickets/MHGPYF9K.txt"`
``` 
...
**Tip:** Copy the "Create Ticket" workflow from P1
...
| **Operation**      | Create                                         |
| **Repository**     | demo-building-ai-workflows-and-agents-with-n8n |
| **File Path**      | `project 4/tickets/{{ $json.ID }}.txt`         |
