...
**Tip:** Copy the "Create Ticket" workflow from P4
...
| **File Path**      | `project 5/tickets/{{ $json.ID }}.txt`         |
...
```markdown
Tickets are stored in the directory `project 5/tickets/`.
Example path: "project 5/tickets/MHGPYF9K.txt"
```
...
| Parameter            | Value                          |
| -------------------- | ------------------------------ |
| **Workflow**         | P5 – Create Ticket Tool        |
